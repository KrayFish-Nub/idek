...
module.exports = {
    ...
    run: async (client, interaction, args, message) => {
        const radioEmbed = new MessageEmbed()
            .setAuthor("Started Playing ZooRadio 90.8 !", interaction.client.user.avatarURL({ dynamic: true }))
        ...
        let resource = createAudioResource('http://netradio.live24.gr/zoo908thess');
