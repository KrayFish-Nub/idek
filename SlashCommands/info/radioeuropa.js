...
module.exports = {
    ...
    run: async (client, interaction, args, message) => {
        const radioEmbed = new MessageEmbed()
            .setAuthor("Started Playing Europa2 Radio.", interaction.client.user.avatarURL({ dynamic: true }))
        ...
        let resource = createAudioResource('http://stream.radioservices.sk/europa2.mp3');
