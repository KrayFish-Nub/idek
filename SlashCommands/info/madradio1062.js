...
module.exports = {
    name: 'madradio',
    description: 'Mad Radio 106.2 radio station',
    ...
    run: async (client, interaction, args, message) => {
        const radioEmbed = new MessageEmbed()
            .setAuthor("Started Playing Mad Radio 106.2 !", interaction.client.user.avatarURL({ dynamic: true }))
        ...
        let resource = createAudioResource('http://mediaserver.mad.tv:80/stream');
